                ...
                if let httpResponse = response as? HTTPURLResponse {
                    ...
                    if httpResponse.statusCode == 200 {
                        ...
                        if contentLength == "0" || !hasContent {
                            ...
                            print("🚫 Empty response (do nothing): Showing ColorQuest")
                            self.isBlock = true
                            self.isFetched = true
                        } else {
                            // Есть контент = успех
                        ...
                        print("🚫 Error code \(httpResponse.statusCode): Showing ColorQuest")
                        self.isBlock = true
                        self.isFetched = true
                    }
                    ...
                    print("❌ No HTTP response: Showing ColorQuest")
                    self.isBlock = true
                    self.isFetched = true
                }
            }
